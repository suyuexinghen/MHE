...
from metaharness_ext.deepmd.contracts import DPGenAutotestSpec, DPGenRunSpec, DPGenSimplifySpec


def build_dpgen_machine_json(
    spec: DPGenRunSpec | DPGenSimplifySpec | DPGenAutotestSpec,
) -> dict[str, Any]:
