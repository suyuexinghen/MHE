...
**Note:** The next time you visit pyquafu, you don't have to save the token again. Yet a quafu token is not permanently validating, from time to time you may click `refresh` to get a new one on webpage.
...
For quantum gates Quafu supports, please check the API reference for [Quantum Circuit](./apiref.md#quantum-circuit) or use python-buitin `dir()` method.
...
![png](https://scq-cloud.github.io/_images/output_23_0.png)
...
![image1](https://scq-cloud.github.io/_images/output_28_0.png)
...
![png](https://scq-cloud.github.io/_images/output_37_1.png)
...
![image2](https://scq-cloud.github.io/_images/output_39_0.png)
...
![image3](https://scq-cloud.github.io/_images/output_41_0.png)
...
![image4](https://scq-cloud.github.io/_images/output_45_0.png)
...
```
[0.70710678+0.j 0.70710678+0.j](0.7071067811865475+0j)
...
![image5](https://scq-cloud.github.io/_images/output_55_0.png)

![png](https://scq-cloud.github.io/_images/output_55_1.png)
...
In the above examples, we chose opening python kernal and waiting for the result. You may also submit the task asynchronously. Here we use another example that measures the qubit decoherence time T1 to demonstrate the usage.
...
Once all the tasks are completed, we can do the next step to get T1.
...
![image6](https://scq-cloud.github.io/_images/output_67_1.png)
...
Finally, you can also retrieve a single task using its unique `task_id`, and download all the historical tasks in webpage.
